...
**Заголовок:** НЕ отображаются введенные данные пользователем в поле "пол" при заполнении формы регистрации  
...
Форма успешно создана.  
НЕ отображаютсяя введенные данные пользователем в поле "пол"    
